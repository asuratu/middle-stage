...
var file_usersvc_proto_rawDesc = []byte{
	...
	0x6b, 0x32, 0xad, 0x0a, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x73, 0x76, 0x63, 0x12, 0x3a, 0x0a,
	...
	,
...
var file_usersvc_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
...
var file_usersvc_proto_depIdxs = []int32{
	...
	2,  // 28: user.usersvc.AddCategory:output_type -> user.AddCategoryResp
	4,  // 29: user.usersvc.UpdateCategory:output_type -> user.UpdateCategoryResp
	6,  // 30: user.usersvc.DelCategory:output_type -> user.DelCategoryResp
	8,  // 31: user.usersvc.GetCategoryById:output_type -> user.GetCategoryByIdResp
	10, // 32: user.usersvc.SearchCategory:output_type -> user.SearchCategoryResp
	13, // 33: user.usersvc.AddTopic:output_type -> user.AddTopicResp
	15, // 34: user.usersvc.UpdateTopic:output_type -> user.UpdateTopicResp
	17, // 35: user.usersvc.DelTopic:output_type -> user.DelTopicResp
	19, // 36: user.usersvc.GetTopicById:output_type -> user.GetTopicByIdResp
	21, // 37: user.usersvc.SearchTopic:output_type -> user.SearchTopicResp
	23, // 38: user.usersvc.LoginByPhone:output_type -> user.tokenResp
	23, // 39: user.usersvc.Register:output_type -> user.tokenResp
	23, // 40: user.usersvc.GenerateToken:output_type -> user.tokenResp
	23, // 41: user.usersvc.RefreshToken:output_type -> user.tokenResp
	29, // 42: user.usersvc.UpdateUser:output_type -> user.UpdateUserResp
	31, // 43: user.usersvc.DelUser:output_type -> user.DelUserResp
	34, // 44: user.usersvc.GetUserById:output_type -> user.GetUserResp
	34, // 45: user.usersvc.GetUserByMobile:output_type -> user.GetUserResp
	36, // 46: user.usersvc.SearchUser:output_type -> user.SearchUserResp
	38, // 47: user.usersvc.SendImageCaptcha:output_type -> user.SendImageCaptchaResp
	42, // 48: user.usersvc.VerifyCaptcha:output_type -> user.VerifyCaptchaResp
	40, // 49: user.usersvc.SendSmsCode:output_type -> user.SendSmsCodeResp
